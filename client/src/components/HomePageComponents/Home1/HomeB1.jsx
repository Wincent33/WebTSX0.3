...
export default function HomeB1() {
  ...
  return (
    <section className="flex flex-col bg-transparent h-[600px] w-[90vw] ">
      <div className="absolute w-full h-[600px] -z-1 ">
        <MovingBackground />
      </div>
      <div className="mx-auto w-[1300px]">
        <div className="flex flex-row items-center z-10 mx-auto justify-between">
          <div className="flex flex-row items-center justify-between content-around w-full">
        ...
        <div className="flex flex-row justify-between relative">
          <div className="w-[50%]">
            <h1 className="text-white text-[56px] ml-[150px] drop-shadow-[7px_7px_3px_black] my-[50px]">
